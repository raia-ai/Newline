...
with the un sold lots and these options are under  the  Status  column.  The
default option is to Move to Store if an unsold pass has  not  been  printed
for any lots. If a pass out has been  printed  then  this  will  default  to
‘Returned to Vendor’. The other option in this list is Skip / Dump.
...
Option 4 displays the same screens and information as Option 3.
